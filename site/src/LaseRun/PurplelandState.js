...
(function(undefined) {
    ...
    var PurplelandState = function() {
        var assets = LaseRun.path.assets;
        PurplelandState.super[0].call(this, 
        {
            "name": "PurplelandState",
            "resources": {
                "rules": {path: assets.level.child("PurplelandState/rules.json")},
                "sky": {path: assets.common.child("bitmap/purpleSky.png")},
                ...
                "tilemap": {
                    "path": assets.level.child("PurplelandState/map.json"),
    ...
    LaseRun.extend(PurplelandState, LaseRun.BaseLevelState);

    LaseRun.PurplelandState = PurplelandState;
