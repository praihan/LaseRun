...
(function(undefined) {
    ...
    s.run = function(GAMEDIV, VIEWPORT_X, VIEWPORT_Y, COMMON_DIR, LEVEL_DIR) {
        ...
        var preload = function() {
            this.load.audio("LaseRun/music", [path.assets.common.child("audio/music.mp3"), path.assets.common.child("audio/music.ogg")], true);
        }
        ...
        var create = function() {
            ...
            LaseRun.music = this.add.audio("LaseRun/music", (LaseRun.settings.musicEnabled ^ true) ^ true, true);
            LaseRun.music.play();
