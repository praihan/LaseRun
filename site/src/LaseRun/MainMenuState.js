...
(function(undefined) {
    ...
    p.preload = function() {
        ...
        this.load.image("MainMenuState/ui/background", assets.level.child("MainMenuState/background.png"));
    ...
    p.create = function() {
        ...
        var button = this.add.labelButton((this.stage.bounds.width / 2 - 186 / 2), 400, "MainMenuState/ui/button", 
        {
            font: "50px monospace", 
            fill: "white"
        }, 
